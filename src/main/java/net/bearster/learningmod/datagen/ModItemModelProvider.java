...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        handheldItem(ModItems.BLACK_OPAL_SWORD.get());
        handheldItem(ModItems.BLACK_OPAL_PICKAXE.get());
        handheldItem(ModItems.BLACK_OPAL_SHOVEL.get());
        handheldItem(ModItems.BLACK_OPAL_AXE.get());
        handheldItem(ModItems.BLACK_OPAL_HOE.get());

        handheldItem(ModItems.BLACK_OPAL_PAXEL.get());
        handheldItem(ModItems.BLACK_OPAL_HAMMER.get());
