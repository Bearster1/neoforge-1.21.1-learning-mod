...
public class LearningMod {
    ...
    public static ResourceLocation LOC(String name) {
        return ResourceLocation.fromNamespaceAndPath(LearningMod.MOD_ID, name);
    }
    ...
    public LearningMod(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (LearningMod) to respond directly to events.
